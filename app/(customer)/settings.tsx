  ...
  return (
    <View className={`flex-1 ${isDark ? 'dark' : ''} bg-background`}>
      ...
      <ScrollView className="flex-1">
        ...
        {/* Notifications */}
        {renderMenuSection('NOTIFICATIONS')}
        <View className={`mx-4 rounded-xl bg-card shadow-sm px-4`}>
          {renderSettingItem(
            'notifications-outline', 
            'Push Notifications', 
            'Receive alerts about appointment updates', 
            notifications, 
            setNotifications
          )}
          {renderSettingItem(
        ...
        <View className="mx-4 mb-12">
          <View className="flex-row justify-center">
            <Text className="text-xs text-muted-foreground mx-2">Privacy Policy</Text>
            <Text className="text-xs text-muted-foreground mx-2">Terms of Service</Text>
          </View>
        </View>
      </ScrollView>
    </View>
